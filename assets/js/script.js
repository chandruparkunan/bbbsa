...
else if (findName == $("#DefferedEstablishmentFees").attr("id")) {
            $("#DefferedEstablishmentFees").text(decodeURIComponent(findValue));
            $("#DefferedEstablishmentFees1").text(  findValue);
        }

//else if (findName == $("#LegalFees").attr("id")) {
//            $("#LegalFees").text(decodeURIComponent(findValue));
//            $("#LegalFees1").text(  findValue);
//        }
        ...
        else if (findName == $("#AnnualFacilityFees").attr("id")) {
            $("#AnnualFacilityFees").text( findValue);
        }
        else if (findName == $("#AnnualFacilityPercentage").attr("id")) {
            $("#AnnualFacilityPercentage").text( findValue);
        }
...
function rky3(e){
  document.getElementById('rksy3').innerHTML=(e.target.value);
}